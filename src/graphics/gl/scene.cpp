...
Rgb_spectrum Gl_scene::get_ambient_irradiance() const noexcept {
  return _ambient_irradiance;
}

void Gl_scene::set_ambient_irradiance(
    Rgb_spectrum ambient_irradiance) noexcept {
  _ambient_irradiance = ambient_irradiance;
}

std::optional<Directional_light> const &
Gl_scene::get_directional_light() const noexcept {
  return _directional_light;
}

void Gl_scene::set_directional_light(
